//
//  FeedAnimationTransitionAdmin.swift
//  GiveCake
//
...
enum AnimationTypeAdmin {
    case present
    case dismiss
}

class FeedAnimationTransitionAdmin: NSObject {
    let animationType: AnimationTypeAdmin!
    
    init(animationType: AnimationTypeAdmin) {
...
// 뷰 전환 커스텀 애니메이션
extension FeedAnimationTransitionAdmin: UIViewControllerAnimatedTransitioning {
